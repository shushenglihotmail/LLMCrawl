...
class TrafilaturaExtractor:
    ...
    async def extract_content(
        ...
        try:
            ...
            extracted_metadata = {}
            if metadata:
                # Handle date safely - could be datetime, string, or None
                date_str = None
                if metadata.date:
            ...
            quality_score = self._calculate_quality_score(
                markdown_content, extracted_metadata, content_stats
            )
    ...
    def _calculate_quality_score(
        self, content: str, metadata: Dict[str, Any], stats: Dict[str, int]
    ) -> float:
        """
    ...
    async def extract_multiple(
        self, html_documents: list[Dict[str, Any]]
    ) -> list[Dict[str, Any]]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"status": "unhealthy", "service": "trafilatura", "error": str(e)}
