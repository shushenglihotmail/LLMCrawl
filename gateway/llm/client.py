...
class LLMClient:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Initialized LLM client: {self.provider}, model: {self.chat_model}"
        )
    ...
    async def chat_completion(
        ...
        Args:
            ...
            model: Model to use (if None, uses self.chat_model from initialization)
        ...
        try:
            ...
            selected_model = model if model else self.chat_model
